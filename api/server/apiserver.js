...
enrollAdmin();
setTimeout(function() { registerUser(); }, 5000);
...
app.post('/api/addemployee/', async function (req, res) {
    try {
        ...
        await contract.submitTransaction('createEmployee', req.body.employeeNumber, req.body.name, req.body.gender, req.body.city, req.body.country);
